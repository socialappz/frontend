    ...
    <main className="bg-white min-h-screen w-full font-['Jost',sans-serif] text-[#35374B]">
      ...
      <header className="max-w-[90%] mx-auto px-2 py-2 md:py-12 grid md:grid-cols-2 gap-0 items-center">
        <div>
          ...
          <p className="text-[18px] text-[#35374B] mb-8 max-w-[480px] leading-relaxed">
            Connect with dog owners near you. Find walking companions, make new
          ...
          <div className="flex flex-wrap gap-6 text-[15px] font-bold text-[#006557]">
            <span className="flex items-center gap-2">
              <img src="/check.svg" className="h-4 w-4" alt="Check" /> Free to
              join
            </span>
            <span className="flex items-center gap-2">
              <img src="/check.svg" className="h-4 w-4" alt="Check" /> 10,000+
              dog owners
            </span>
            <span className="flex items-center gap-2">
              <img src="/check.svg" className="h-4 w-4" alt="Check" /> Safe &
              verified
            </span>
          </div>
        </div>
      ...
      <section className="max-w-[90%] mx-auto px-6 py-12 grid grid md:grid-cols-[30%_70%] gap-3">
        ...
        <div className="w-full h-[350px] md:h-auto md:min-h-[500px] order-2 md:order-2">
          <img
      ...
      <section className="max-w-[90%] mx-auto px-6 py-24" id="works">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {/* Step 1 */}
          <div className="bg-[#FCF8EA] rounded-[2.5rem] p-10 md:p-12 flex flex-col items-center text-center">
            <span className="text-5xl mb-8">🐾</span>
            <h3 className="text-[#00A991] font-bold text-[14px] tracking-[2px] uppercase mb-4">
              Step 01
            </h3>
            <h4 className="text-[24px] font-extrabold text-[#35374B] mb-4">
              Create Your Profile
            </h4>
            <p className="text-[#35374B] leading-relaxed text-[15px]">
              Set up profiles for you and your dog. Add breed, favourite
              activities, and your walk schedule.
            </p>
          </div>
          {/* Step 2 */}
          <div className="bg-[#004C41] rounded-[2.5rem] p-10 md:p-12 flex flex-col items-center text-center">
            <span className="text-5xl mb-8">🔍</span>
            <h3 className="text-[#90E4DD] font-bold text-[14px] tracking-[2px] uppercase mb-4">
              Step 02
            </h3>
            <h4 className="text-[24px] font-extrabold text-white mb-4">
              Find Dog Friends
            </h4>
            <p className="text-[#90E4DD] leading-relaxed text-[15px]">
              Browse dog owners in your city. Filter by breed, size, energy
              level, and available walk times.
            </p>
          </div>
          {/* Step 3 */}
          <div className="bg-[#FCF8EA] rounded-[2.5rem] p-10 md:p-12 flex flex-col items-center text-center">
            ...
            <p className="text-[#35374B] leading-relaxed text-[15px]">
              Chat, plan meetups, and share adventures. Build a real community
              of dog lovers right in your neighbourhood.
            </p>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-[#004C41] py-16 px-6 mt-12 flex flex-col items-center">
        ...
        />
        <div className="flex flex-wrap justify-center gap-8 text-white font-bold mb-10 text-[15px]">
          <a href="#" className="hover:text-[#90E4DD] transition">
            Privacy
          </a>
          <a href="#" className="hover:text-[#90E4DD] transition">
            Terms
        ...
        <p className="text-[#00A991] text-[14px]">
          © 2026 Dinder · Made with{" "}
