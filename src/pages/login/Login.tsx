          ...
          <form onSubmit={loginHandler} className="space-y-6">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <a
                  href="#"
                  className="text-sm text-black! hover:text-blue-500! font-medium"
                >
                  Password forget?
                </a>
              </div>
